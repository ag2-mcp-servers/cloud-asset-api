...
class AnalyzeIamPolicyLongrunningResponse(BaseModel):
    pass
...
class GoogleCloudAssetV1p7beta1PartitionSpec(BaseModel):
    partitionKey: Optional[PartitionKey] = Field(
        None, description='The partition key for BigQuery partitioned table.'
    )
...
class GoogleCloudAssetV1p7beta1RelationshipAttributes(BaseModel):
    action: Optional[str] = Field(
        None, description='The detail of the relationship, e.g. `contains`, `attaches`'
    )
    sourceResourceType: Optional[str] = Field(
        None,
        description='The source asset type. Example: `compute.googleapis.com/Instance`',
    )
    targetResourceType: Optional[str] = Field(
        None,
...
class GoogleCloudAssetV1p7beta1Resource(BaseModel):
    ...
    discoveryDocumentUri: Optional[str] = Field(
        None,
    ...
    discoveryName: Optional[str] = Field(
        None,
    ...
    version: Optional[str] = Field(None, description='The API version. Example: `v1`')
...
class GoogleCloudOrgpolicyV1ListPolicy(BaseModel):
    allValues: Optional[AllValues] = Field(
        None, description='The policy all_values state.'
    )
...
class GoogleCloudOrgpolicyV1RestoreDefault(BaseModel):
    pass
...
class GoogleIdentityAccesscontextmanagerV1IngressSource(BaseModel):
    accessLevel: Optional[str] = Field(
        None,
...
class GoogleIdentityAccesscontextmanagerV1MethodSelector(BaseModel):
...
class GoogleCloudAssetV1p7beta1BigQueryDestination(BaseModel):
    ...
    partitionSpec: Optional[GoogleCloudAssetV1p7beta1PartitionSpec] = Field(
        None,
    ...
    separateTablesPerAssetType: Optional[bool] = Field(
        None,
...
class GoogleCloudAssetV1p7beta1OutputConfig(BaseModel):
    bigqueryDestination: Optional[GoogleCloudAssetV1p7beta1BigQueryDestination] = Field(
        None,
        description='Destination on BigQuery. The output table stores the fields in asset proto as columns in BigQuery.',
    )
    gcsDestination: Optional[GoogleCloudAssetV1p7beta1GcsDestination] = Field(
        None, description='Destination on Cloud Storage.'
    )


class GoogleCloudAssetV1p7beta1RelatedAssets(BaseModel):
    assets: Optional[List[GoogleCloudAssetV1p7beta1RelatedAsset]] = Field(
        None, description='The peer resources of the relationship.'
    )
    relationshipAttributes: Optional[
        GoogleCloudAssetV1p7beta1RelationshipAttributes
    ] = Field(None, description='The detailed relation attributes.')


class GoogleCloudOrgpolicyV1Policy(BaseModel):
    booleanPolicy: Optional[GoogleCloudOrgpolicyV1BooleanPolicy] = Field(
        None,
    ...
    listPolicy: Optional[GoogleCloudOrgpolicyV1ListPolicy] = Field(
        None, description='List of values either allowed or disallowed.'
    )
    restoreDefault: Optional[GoogleCloudOrgpolicyV1RestoreDefault] = Field(
        None,
...
class GoogleIdentityAccesscontextmanagerV1ApiOperation(BaseModel):
    methodSelectors: Optional[
        List[GoogleIdentityAccesscontextmanagerV1MethodSelector]
    ] = Field(
        None,
...
class GoogleIdentityAccesscontextmanagerV1DevicePolicy(BaseModel):
    ...
    osConstraints: Optional[List[GoogleIdentityAccesscontextmanagerV1OsConstraint]] = (
        Field(
            None,
...
class GoogleIdentityAccesscontextmanagerV1EgressTo(BaseModel):
    ...
    operations: Optional[List[GoogleIdentityAccesscontextmanagerV1ApiOperation]] = (
        Field(
            None,
...
class GoogleIdentityAccesscontextmanagerV1IngressFrom(BaseModel):
    ...
    sources: Optional[List[GoogleIdentityAccesscontextmanagerV1IngressSource]] = Field(
        None, description='Sources that this IngressPolicy authorizes access from.'
    )
...
class GoogleCloudAssetV1p7beta1ExportAssetsRequest(BaseModel):
    ...
    outputConfig: Optional[GoogleCloudAssetV1p7beta1OutputConfig] = Field(
        None,
    ...
    relationshipTypes: Optional[List[str]] = Field(
        None,
...
class GoogleIdentityAccesscontextmanagerV1Condition(BaseModel):
    devicePolicy: Optional[GoogleIdentityAccesscontextmanagerV1DevicePolicy] = Field(
        None,
...
class GoogleIdentityAccesscontextmanagerV1EgressPolicy(BaseModel):
    egressFrom: Optional[GoogleIdentityAccesscontextmanagerV1EgressFrom] = Field(
        None,
        description='Defines conditions on the source of a request causing this EgressPolicy to apply.',
    )
    egressTo: Optional[GoogleIdentityAccesscontextmanagerV1EgressTo] = Field(
        None,
...
class GoogleIdentityAccesscontextmanagerV1IngressPolicy(BaseModel):
    ingressFrom: Optional[GoogleIdentityAccesscontextmanagerV1IngressFrom] = Field(
        None,
        description='Defines the conditions on the source of a request causing this IngressPolicy to apply.',
    )
    ingressTo: Optional[GoogleIdentityAccesscontextmanagerV1IngressTo] = Field(
        None,
...
class GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig(BaseModel):
    ...
    egressPolicies: Optional[List[GoogleIdentityAccesscontextmanagerV1EgressPolicy]] = (
        Field(
            None,
    ...
    ingressPolicies: Optional[
        List[GoogleIdentityAccesscontextmanagerV1IngressPolicy]
    ] = Field(
        None,
    ...
    vpcAccessibleServices: Optional[
        GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices
    ] = Field(None, description='Configuration for APIs allowed within Perimeter.')


class GoogleIdentityAccesscontextmanagerV1BasicLevel(BaseModel):
    ...
    conditions: Optional[List[GoogleIdentityAccesscontextmanagerV1Condition]] = Field(
        None,
...
class GoogleIdentityAccesscontextmanagerV1ServicePerimeter(BaseModel):
    ...
    spec: Optional[GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig] = Field(
        None,
    ...
    status: Optional[GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig] = (
        Field(
            None,
...
class GoogleIdentityAccesscontextmanagerV1AccessLevel(BaseModel):
    basic: Optional[GoogleIdentityAccesscontextmanagerV1BasicLevel] = Field(
        None, description='A `BasicLevel` composed of `Conditions`.'
    )
    custom: Optional[GoogleIdentityAccesscontextmanagerV1CustomLevel] = Field(
...
class GoogleCloudAssetV1p7beta1Asset(BaseModel):
    accessLevel: Optional[GoogleIdentityAccesscontextmanagerV1AccessLevel] = Field(
        None,
    ...
    accessPolicy: Optional[GoogleIdentityAccesscontextmanagerV1AccessPolicy] = Field(
        None,
    ...
    iamPolicy: Optional[Policy] = Field(
        None,
    ...
    orgPolicy: Optional[List[GoogleCloudOrgpolicyV1Policy]] = Field(
        None,
    ...
    relatedAssets: Optional[GoogleCloudAssetV1p7beta1RelatedAssets] = Field(
        None,
        description='The related assets of the asset of one relationship type. One asset only represents one type of relationship.',
    )
    resource: Optional[GoogleCloudAssetV1p7beta1Resource] = Field(
        None, description='A representation of the resource.'
    )
    servicePerimeter: Optional[GoogleIdentityAccesscontextmanagerV1ServicePerimeter] = (
        Field(
            None,
